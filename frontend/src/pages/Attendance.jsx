                    ...
                    <div className="action-buttons">
                        {
                            allowedActions.map((action) => (
                                <button key={action} className="action-button" disabled={ !locationAllowed || locationName === "Fetching location..."} onClick={() => handleAttendance(action)}>
                                    {action}
                                </button>
                            ))
                        }
                        ...
                        attendance.today_history?.map((record, index) => (
                            <div key={index} className="timeline-item">
                                <div className="timeline-line">
                                    <div className={`timeline-dot ${record.action === "Check In"? "green": record.action === "Break"? "orange": record.action === "Break Over"? "blue": "red"}`}>
                                    </div>
                                    {
