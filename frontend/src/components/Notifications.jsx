                                ...
                                {!notification.is_read && (
                                    <div className="notification-actions">
                                        {notification.title === "Attendance Incomplete" && (
                                            <button className="resolve-btn" onClick={() => handleResolve(notification)}>
                                                Resolve Now
                                            </button>
                                        )}
                ...
                showResolveModal && (
                    ...
                    <div className="resolve-modal-overlay">
                        ...
                        <div className="resolve-modal">
                            ...
                            <p>
                                Yesterday's attendance is incomplete.
                            ...
                            <div className="form-group">
                                ...
                                <textarea rows="4" value={notes} onChange={(e) => setNotes(e.target.value)} placeholder="Enter additional details..."/>
